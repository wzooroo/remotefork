...
# ACE Stream
/opt/acestream/start-engine --client-console @/opt/acestream/acestream.conf --bind-all --access-token $2 --cache-dir /tmp/state/.ACEStream --state-dir /tmp/state/.ACEStream --service-remote-access --stats-report-peers >/dev/null 2>&1 &
